...
public class Util {
    ...
    public static final String READER_LOCATION = System.getProperty("es.path.home")
            + File.separator + "opendistro_performance_analyzer" + File.separator;
    public static final String DATA_DIR = System.getProperty("es.path.home")
            + File.separator + "var" + File.separator + "es" + File.separator + "data" + File.separator;
