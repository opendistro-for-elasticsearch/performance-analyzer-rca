...
public class PerformanceAnalyzerApp {
  ...
  private static BlockingQueue<PerformanceAnalyzerTaskException> concurrentQueue =
  ...
  public static void main(String[] args) throws Exception {
    ...
    ClientServers clientServers = getClientServers(settings);

    // the top level thread manager.
    TaskManager taskManager = new TaskManager(concurrentQueue);

    ControllableTask readerTask = new PerformanceAnalyzerReaderTask(concurrentQueue);
    ...
    ControllableTask webServerTask = new WebServerRunnerTask(clientServers.getHttpServer(), concurrentQueue);
    taskManager.submit(webServerTask);

    final RcaController rcaController = new RcaController(netOperationsExecutor,
    ...
    ControllableTask rcaControllerTask = new RcaControllerTask(rcaController,
        RcaConsts.RCA_STATE_CHECK_INTERVAL_IN_MS, concurrentQueue);
   ...
   */
  public static ClientServers getClientServers(PluginSettings settings) {
