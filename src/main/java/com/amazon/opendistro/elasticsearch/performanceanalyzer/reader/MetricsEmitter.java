...
public class MetricsEmitter {
    ...
    public static void emitMasterEventMetrics(MetricsDB metricsDB, MasterEventMetricsSnapshot masterEventMetricsSnapshot) {
        ...
        long mFinalT = System.currentTimeMillis();
        LOG.debug("Total time taken for writing master event queue metrics metricsdb: {}", mFinalT - mCurrT);
    }
    ...
    public static void emitNodeMetrics(final DSLContext create,
        ...
        for (Map.Entry<String, SelectHavingStep<Record>> entry : metadataTable
            ...
            long mFinalT = System.currentTimeMillis();
            LOG.debug("Total time taken for aggregating {} : {}", tableName,
                    mFinalT - mCurrT);
            ...
            mFinalT = System.currentTimeMillis();
            LOG.debug("Total time taken for writing {} metrics metricsdb: {}",
