...
public interface MetricsProcessor {
    ...
    default void saveMetricValues(String value, long startTime, String... keysPath) {
        Util.invokePrivileged(() -> PerformanceAnalyzerMetrics.emitMetric(
                PerformanceAnalyzerMetrics.getTimeInterval(startTime, MetricsConfiguration.SAMPLING_INTERVAL), getMetricsPath(startTime, keysPath), value));
    }
