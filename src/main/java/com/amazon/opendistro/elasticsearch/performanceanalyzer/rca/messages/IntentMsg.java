...
public class IntentMsg {
    /**
     * The node sending the intent. This is the node whose one or more dependency is not locally available.
     */
    ...
    /**
     * The requesting node's rca.conf tags.
     * This tags will be used by the requested Node's network thread to send data.
     */
