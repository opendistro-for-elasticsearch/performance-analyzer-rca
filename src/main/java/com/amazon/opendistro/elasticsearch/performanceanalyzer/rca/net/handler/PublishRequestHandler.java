...
public class PublishRequestHandler {
    ...
    public PublishRequestHandler(final NetPersistor persistor, final NodeStateManager nodeStateManager) {
        this.persistor = persistor;
        this.nodeStateManager = nodeStateManager;
    }

    public StreamObserver<FlowUnitMessage> getClientStream(final StreamObserver<PublishResponse> serviceResponse) {
    ...
    public void terminateUpstreamConnections() {
        for (final StreamObserver<PublishResponse> responseStream : upstreamResponseStreamList) {
            responseStream.onNext(PublishResponse.newBuilder()
