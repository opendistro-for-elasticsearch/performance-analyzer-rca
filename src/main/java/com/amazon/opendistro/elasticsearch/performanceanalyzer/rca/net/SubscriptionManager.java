...
public class SubscriptionManager {
    ...
    public SubscriptionManager(final GRPCConnectionManager connectionManager, final NetClient netClient) {
        this.connectionManager = connectionManager;
        this.netClient = netClient;
    }

    public void broadcastSubscribeRequest(final String requesterGraphNode, final String destinationGraphNode, final Map<String, String> tags) {
    ...
    public void sendSubscribeRequest(final String remoteHost, final String requesterGraphNode, final String destinationGraphNode, final Map<String, String> tags) {
        LOG.debug("Sending subscribe message to: {}. Need {} to compute {}", remoteHost, destinationGraphNode, requesterGraphNode);
        netClient.subscribe(remoteHost, buildSubscribeMessage(requesterGraphNode, destinationGraphNode, tags), new SubscriptionResponseHandler(remoteHost, destinationGraphNode));
    }
    ...
    private SubscribeMessage buildSubscribeMessage(final String requesterGraphNode, final String destinationGraphNode, final Map<String, String> tags) {
    ...
    public SubscriptionStatus addSubscriber(final String graphNode, final String subscriberHostAddress, final String locus) {
