...
/**
 * JvmGenerationAction modifies a generational Garbage Collector's tuning parameters
 *
 * <p>This class is currently used to tune the young generation size when the CMS collector is being used
 */
public class JvmGenerationAction extends SuppressibleAction {
  public static final String NAME = "JvmGenerationAction";
  ...
  public String summary() {
    ...
    return String.format(
        "Update NewRatio to [%d] on all data nodes",
        targetRatio);
  }
