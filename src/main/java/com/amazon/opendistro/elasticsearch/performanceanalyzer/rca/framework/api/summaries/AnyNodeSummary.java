...
/**
 * AnyNodeSummary is a HotNodeSummary which may contain a summary of healthy node values
 */
public class AnyNodeSummary extends HotNodeSummary {
  private boolean isHot;

  public AnyNodeSummary(Id nodeID, Ip hostAddress, boolean isHot) {
