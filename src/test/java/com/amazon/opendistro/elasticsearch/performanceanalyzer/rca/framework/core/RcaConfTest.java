...
public class RcaConfTest {
    ...
    public void testReadRcaConfig() {
        ...
        Assert.assertEquals(
                HighHeapUsageYoungGenRcaConfig.DEFAULT_PROMOTION_RATE_THRESHOLD_IN_MB_PER_SEC, promotionRateThreshold.intValue());
        ...
        Integer fieldDataTimePeriod =
                rcaConf.readRcaConfig(
                        CacheConfig.CONFIG_NAME,
                        CacheConfig.RCA_CONF_KEY_CONSTANTS.FIELD_DATA_COLLECTOR_TIME_PERIOD_IN_SEC,
                        Integer.class);
        Assert.assertNull(val);
        ...
        Integer shardRequestTimePeriod =
                rcaConf.readRcaConfig(
                        CacheConfig.CONFIG_NAME,
                        CacheConfig.RCA_CONF_KEY_CONSTANTS.SHARD_REQUEST_COLLECTOR_TIME_PERIOD_IN_SEC,
                        Integer.class);
        Assert.assertNull(val);
