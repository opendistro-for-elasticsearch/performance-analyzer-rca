...
public class MetricsParserTest {
  ...
  public void testMetricsParser() throws Exception {
    ...
    HttpRequestMetricsSnapshot hRqSnap =
        new HttpRequestMetricsSnapshot(mp.getConnection(), 1535065195000L);
    parser.parseHttpMetrics(
        "build/private/test_resources/dev/shm", 1535065195000L, 1535065200000L, hRqSnap);
    parser.parseRequestMetrics(
        "build/private/test_resources/dev/shm", 1535065195000L, 1535065200000L, rqSnap);
  ...
  public void testOSMetricRotateParse() throws Exception {
    ...
    try (CopyTestResource testResource =
        new CopyTestResource(
            "build/private/test_resources/dev/shm",
      ...
      try {
        ...
        parser.parseOSMetrics(
            testResource.getPath(), 1535065195000L, 1535065200000L, osMetricsSnap);
