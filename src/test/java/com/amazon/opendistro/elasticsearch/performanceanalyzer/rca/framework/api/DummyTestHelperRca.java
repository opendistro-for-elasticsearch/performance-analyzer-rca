...
public class DummyTestHelperRca<S extends GenericSummary> extends Rca<ResourceFlowUnit<S>> {
  public DummyTestHelperRca() {
    super(5);
  }

  public void mockFlowUnit(ResourceFlowUnit<S> flowUnit) {
    this.flowUnits = Collections.singletonList(flowUnit);
  }

  public void mockFlowUnits(List<ResourceFlowUnit<S>> flowUnitList) {
    this.flowUnits = flowUnitList;
  }

  @Override
  public ResourceFlowUnit<S> operate() {
    return null;
  }
