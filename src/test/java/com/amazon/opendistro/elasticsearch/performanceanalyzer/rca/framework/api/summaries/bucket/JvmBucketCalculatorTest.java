...
public class JvmBucketCalculatorTest extends BucketCalculatorTest {
  ...
  void verifyCompute() {
    ...
    Assert.assertEquals(UsageBucket.UNDER_PROVISIONED, uut.compute(youngGen, 70.0));
    ...
    Assert.assertEquals(UsageBucket.UNDER_PROVISIONED, uut.compute(oldGen, 7.1));
