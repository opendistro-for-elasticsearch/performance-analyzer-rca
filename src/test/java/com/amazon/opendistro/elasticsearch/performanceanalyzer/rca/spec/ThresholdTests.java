...
public class ThresholdTests {
    private static final String confPath = Paths.get(RcaConsts.TEST_CONFIG_PATH, "rca.conf").toString();
    private static final String thPath = Paths.get(RcaConsts.TEST_CONFIG_PATH, "thresholds").toString();
    ...
    public void testValidationNoOverridesButPrecedenceOrder() throws IOException, MalformedThresholdFile {
        new ThresholdMain(thPath, rcaConf).get("test-null-overrides", rcaConf);
    }

    @Test(expected = OverridesAndPrecedenceOrderValueMismatch.class)
    public void testValidationNoPrecedenceOrderButOverrides() throws IOException, MalformedThresholdFile {
        new ThresholdMain(thPath, rcaConf).get("test-null-precedence-order", rcaConf);
    }

    @Test(expected = OverridesAndPrecedenceOrderValueMismatch.class)
    public void testValidationOverridesPrecedenceOrderKeyMismatch() throws IOException, MalformedThresholdFile {
    ...
    public void testValidationOverridesPrecedenceOrderCountMismatch() throws IOException, MalformedThresholdFile {
