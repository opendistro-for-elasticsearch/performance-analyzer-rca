...
public class QueryMetricsRequestHandlerTests {
    ...
    public void testQueryJson() throws Exception {
        ...
        serviceHandler.collectStats(mp.getMetricsDB().getValue(),1234L,Arrays.asList(OSMetrics.CPU_UTILIZATION.toString()),Arrays.asList("sum"), Arrays.asList(AllMetrics.CommonDimension.SHARD_ID.toString(),
                AllMetrics.CommonDimension.INDEX_NAME.toString(),
                AllMetrics.CommonDimension.OPERATION.toString()),responseObserver);
