...
public class RcaSpecTests {
    ...
    public void testGraphId() {
        ...
        List<List<String>> expectedG1 = Arrays.asList(
        ...
        List<List<String>> expectedG2 = Arrays.asList(
        ...
        for (ConnectedComponent g: stats.getConnectedComponents()) {
            ...
            for (List<Node> parallelExecutables: g.getAllNodesByDependencyOrder()) {
                parallelExecutables.sort((o1, o2) -> o1.getClass().getSimpleName().compareTo(o2.getClass().getSimpleName()));
                List<String> actual =
                        parallelExecutables.stream().map(n -> n.getClass().getSimpleName()).collect(Collectors.toList());
