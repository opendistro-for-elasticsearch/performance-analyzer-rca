...
public class OSMetricHelper {
     ...
     * @param dimVales The value of the dimensions. The dimensions are interpreted in this order: shardID, index
     *                 name, operation value and shard role.
     */
    public static void insert(MetricsDB metricsDB, String metricName, double value, List<String> dimVales) {
        Dimensions dimensions = new Dimensions();
