...
import com.amazon.opendistro.elasticsearch.performanceanalyzer.rca.store.rca.cluster.GenericClusterRca;
...
public class GenericClusterRcaTest {
  private GenericClusterRca clusterRca;
  ...
  public void init() {
    ...
    clusterRca = new GenericClusterRca(1, nodeRca, Arrays.asList(
        type1,
        type2
    ));
  }
